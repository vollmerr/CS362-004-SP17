...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  {
  case adventurer:
    return effect_adventurer(state);

  case council_room:
    return effect_council_room(handPos, state);
  ...
  case smithy:
    return effect_smithy(handPos, state);
  ...
  case minion:
    return effect_minion(handPos, state, choice1, choice2);
  ...
  case cutpurse:
    return effect_cutpurse(handPos, state);
